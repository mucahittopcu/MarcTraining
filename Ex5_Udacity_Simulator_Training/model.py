...
flags.DEFINE_string('drives', '/home/mucahit/Documents/udacity_car_nanodegree_project03/DataSet', 'a ":" separated string of paths to the drive directories')
...
def main(drives=FLAGS.drives, validation_split=FLAGS.validation_split, batch_size=FLAGS.batch_size, epochs=FLAGS.epochs, convolve=FLAGS.convolve, correction=FLAGS.correction, use_generator=FLAGS.use_generator,
    ...
    # save the model
    model_h5 = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(drives_list[0]))), 'model2.h5')
